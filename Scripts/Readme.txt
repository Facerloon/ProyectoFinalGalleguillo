Este proyecto se trata de una aplicacion web que permita crear personajes de un juego de rol bastante complejo. Utiliza un sistema de puntos,
cada atributo, habilidad, ventaja o desventaja que le sumemos al personaje va a sumar o restar puntos, por eso el costo final puede ser negativo.
